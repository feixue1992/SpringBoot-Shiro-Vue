...
import com.edu.config.exception.CommonJsonException;
import com.edu.util.constants.Constants;
...
public class CommonUtil {
    ...
    /**
     * 查询分页结果后的封装工具方法 (用于mybatis对应的方法，目前没用)
     *
    ...
    /**
     * 在分页查询之前,为查询条件里加上分页参数 (用于mybatis对应的方法，目前没用)
     *
    ...
    /**
     * 分页查询之前的处理参数 (用于mybatis对应的方法，目前没用)
