package com.edu.config.mybatis;
...
/**
 * @author lzh
 * @create 2018-02-08-11:39
 */
public class MysqlGenerate {

    private static String packageName = "edu";    //文件路径
    private static String authorName = "lzh";     //作者
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("")
                        .setUrl("jdbc:mysql://127.0.0.1:3306/admin_manager?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
